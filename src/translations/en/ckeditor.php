...
return [
    ...
    'Show toolbar buttons for entry types that have icons' => 'Show toolbar buttons for entry types that have icons',
    ...
    'Whether the entry types that have icons should be shown as separate buttons in the toolbar.' => 'Whether the entry types that have icons should be shown as separate buttons in the toolbar.',
